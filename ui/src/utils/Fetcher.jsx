...
const DepositPoints = (userId, points, circleID) => {
  return Fetch(`/circles/${circleID}/members/points/deposit`, {
    method: 'POST',
    headers: HEADERS(),
    body: JSON.stringify({ points, userId }),
  })
...
const GetRewards = () => {
  return Fetch('/rewards', { method: 'GET', headers: HEADERS() })
}
...
const DeleteReward = rewardId => {
  return Fetch(`/rewards/${rewardId}`, { method: 'DELETE', headers: HEADERS() })
}

const RedeemReward = rewardId => {
  return Fetch(`/rewards/${rewardId}/redeem`, {
    method: 'POST',
    headers: HEADERS(),
  })
}

const GetRewardRedemptions = () => {
  return Fetch('/rewards/redemptions', { method: 'GET', headers: HEADERS() })
}

const FulfillRedemption = redemptionId => {
  return Fetch(`/rewards/redemptions/${redemptionId}/fulfill`, {
    method: 'PUT',
    headers: HEADERS(),
  })
}
...
const CreateManagedUser = (username, displayName, password) => {
...
const DeleteManagedUser = managedUserId => {
  return Fetch(`/users/subaccounts/${managedUserId}`, {
    method: 'DELETE',
    headers: HEADERS(),
  })
...
// Legacy aliases kept so any unconverted callers don't break at runtime
const CreateChildUser = CreateManagedUser
const GetChildUsers = GetManagedUsers
const UpdateChildPassword = (childUserId, password) =>
  UpdateManagedUser(childUserId, { password })
const DeleteChildUser = DeleteManagedUser
...
const MarkProjectTaskDone = (projectId, taskId) => {
  return Fetch(`/projects/${projectId}/tasks/${taskId}/done`, {
    method: 'POST',
    headers: HEADERS(),
  })
}

const ApproveProjectTask = (projectId, taskId) => {
  return Fetch(`/projects/${projectId}/tasks/${taskId}/approve`, {
    method: 'POST',
    headers: HEADERS(),
  })
}

const RejectProjectTask = (projectId, taskId) => {
  return Fetch(`/projects/${projectId}/tasks/${taskId}/reject`, {
    method: 'POST',
    headers: HEADERS(),
  })
}
...
const ReopenProject = projectId => {
  return Fetch(`/projects/${projectId}/reopen`, {
    method: 'POST',
    headers: HEADERS(),
  })
}
